...
- **Conversation export** — `docs/conversation.json`, generated by `tools/export_conversation.py`
  from the Claude Code session transcript (image payloads stripped, long tool outputs truncated).
